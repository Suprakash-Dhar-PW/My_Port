      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-5">
            <a
              href="https://github.com/Suprakash-Dhar-PW"
              target="_blank"
              rel="noopener noreferrer"
              className="group"
            >
              <FaGithub
                className="text-gray-400 group-hover:text-white transition-colors transform group-hover:scale-110"
                size={20}
              />
            </a>
            <a
              href="https://www.linkedin.com/in/suprakash-dhar-504032334/"
              target="_blank"
              rel="noopener noreferrer"
              className="group"
            >
              <FaLinkedin
                className="text-gray-400 group-hover:text-blue-400 transition-colors transform group-hover:scale-110"
                size={20}
              />
            </a>
            <a
              href="https://www.instagram.com/encoure05/"
              target="_blank"
              rel="noopener noreferrer"
              className="group"
            >
              <FaInstagram
                className="text-gray-400 group-hover:text-pink-500 transition-colors transform group-hover:scale-110"
                size={20}
              />
            </a>
          </div>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <div className="flex gap-6 px-3 py-4 border-t border-white/10 mt-2">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <FaLinkedin size={22} className="text-gray-400" />
                </a>
                <a
                  href="https://www.instagram.com/encoure05/"
                  target="_blank"
