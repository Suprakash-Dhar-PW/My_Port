      ...
      <div className="container max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="space-y-2">
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
              Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Suprakash</span>
            </h1>
          ...
          <p className="text-gray-400 leading-relaxed text-lg max-w-lg">
            ...
            Passionate about transforming complex problems into elegant, user-centric solutions. 
            When I'm not coding, I'm exploring new tech trends and contributing to open source.
          </p>
        ...
        >
          ...
          >
            ...
            >
              <div className="text-xs font-bold text-purple-300 mb-1">Current Focus</div>
